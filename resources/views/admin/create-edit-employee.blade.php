    ...
    <div class="col-12">
        <div class="card my-4">
            ...
            <div class="bg-gradient-dark shadow-dark border-radius-lg pt-4 pb-3">
                <h6 class="text-white text-capitalize ps-3"> {{ empty($employee) ? 'Create' : 'Edit' }}  Employee</h6>
            </div>
            </div>
            <div class="card-body px-0 pb-2">
                <div class="table-responsive p-0 m-3">
                    <form action="{{  empty($employee) ?  url('/admin/employee') : url('/admin/employee/' . $employee->username)  }}" method="post" class="m-3">
                        {{ csrf_field() }}
                        ...
                        <div class="ms-md-auto pe-md-3 d-flex align-items-center my-2">
                            <div class="input-group input-group-outline">
                                ...
                                <input type="date" class="form-control" name="date_of_birth" value="{{ $employee->date_of_birth ??   old('date_of_birth')  }}" required>
                            </div>
                        </div>
                        @error('date_of_birth')
                            <div class="invalid-inputan">
